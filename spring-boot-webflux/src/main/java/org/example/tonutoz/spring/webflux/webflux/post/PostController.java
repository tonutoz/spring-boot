...
public class PostController {
  ...
  @GetMapping()
  public Mono<ResponseEntity<List<PostResponse>>> getPostKeyword(@RequestParam(name="keyword",required = true) final String keyword) {
    return postService.getKeywordPost(keyword).collectList().map(ResponseEntity::ok);
  }
